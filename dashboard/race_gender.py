...
def app():
    ...
    st.image(Image.open('figures/bail_type_by_race_pct.png'), width=imgWidth)
    ...
    st.image(Image.open('figures/race_matched_type.png'), width=imgWidth)    
    ...
    # Aggregate race statistics
    st.header("Year-end Summary by Gender")