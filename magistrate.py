...
def app():
    ...
    st.write("**<font color='red'>Question for PBF</font>**: Should we move this section into an 'interesting finds' page?", unsafe_allow_html=True)


    st.header("Analysis while controlling for offense types")
    st.write("While the above figures provide a useful year-end summary, they do not provide a fair comparison of the actors. \
